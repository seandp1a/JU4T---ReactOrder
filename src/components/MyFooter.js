  ...
  return (
    <>
      <footer className="footer mt-auto  pt-5">
        <div className="container pt-5">
          <div className="row pt-5">
            <div className="col-8 row pt-5">
              ...
              <div className="col-sm-4 col-msd col-6 col">
            ...
            <div className="col-4 pl-5 pt-5">
              <div className="brand-title pl-5">
                <span className="footer-title ">追蹤我們的社群</span>
              </div>

              <div className="d-flex footer-brand pl-5  mt-4">
                <a href="#1">
        ...
        <div className="final-row container d-flex justify-content-between">
